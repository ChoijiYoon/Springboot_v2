...
public class Service {
    ...
    public String getStartTime() {
        startTime = DateUtils.format(DateUtils.getServerStartDate(), DateUtils.E_DATE_A_TIME_SEC);
        return startTime;
    }
    ...
    public String getRunTime() {
        runTime = DateUtils.getDatePoor(new Date(), DateUtils.getServerStartDate());
        return runTime;
    }
